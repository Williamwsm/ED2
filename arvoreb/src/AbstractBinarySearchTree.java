public abstract class AbstractBinarySearchTree<T extends Comparable<T>> implements IBalancedTree<T> {
    ...
    protected static class Node<T> {
        ...
        int height;  // Usado para balanceamento de outras árvores
    ...
    @Override
    public abstract void balanceAfterInsert(Node<T> node);  // Balancear após inserção

    @Override
    public abstract void balanceAfterDelete(Node<T> node);  // Balancear após remoção
}
